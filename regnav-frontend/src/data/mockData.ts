    ...
    models: [
      {
        id: 'gpt-4o',
        name: 'GPT-4o',
        description: 'Latest multimodal flagship model, best for complex reasoning',
        maxTokens: 16384,
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        name: 'Claude 3 Opus',
        description: 'Most intelligent Claude 3 model, best for complex tasks',
        maxTokens: 4096,
      ...
      },
      {
        ...
        description: 'Fastest Claude model with improved intelligence',
        maxTokens: 8192,
    ...
    models: [
      {
        ...
        description: 'Next-gen multimodal model with enhanced reasoning',
        maxTokens: 8192,
        costPerToken: 0,
        speedRating: 'fast',
        qualityRating: 'high',
      },
      {
        id: 'gemini-1.5-pro',
        name: 'Gemini 1.5 Pro',
        description: 'Most capable Gemini 1.5, best for complex tasks',
        maxTokens: 8192,
    ...
    models: [
      {
        id: 'gpt-4o-azure',
        name: 'GPT-4o (Azure)',
        description: 'Enterprise-grade GPT-4o with Azure security',
        maxTokens: 16384,
        costPerToken: 0.0000025,
        speedRating: 'fast',
        qualityRating: 'high',
      },
      {
        ...
        description: 'Enterprise-grade GPT-4 Turbo',
        maxTokens: 8192,
        costPerToken: 0.00001,
        speedRating: 'medium',
        qualityRating: 'high',
...
// Module-specific default LLM configurations
